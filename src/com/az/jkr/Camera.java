...
public class Camera {
	...
	{
		int camX = (int)worldToCam(r.x,r.y)[0];
		int camY = (int)worldToCam(r.x,r.y)[1];
	 ...
	 */
	public void drawSprite(Graphics2D g2, BufferedImage sprite, float x, float y, boolean flip)
	{
		int camX = (int)worldToCam(x,y)[0];
		int camY = (int)worldToCam(x,y)[1];
